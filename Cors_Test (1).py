...
class BurpExtender(IBurpExtender, IIntruderPayloadGeneratorFactory, IHttpListener):
    ...
    def processHttpMessage(self, toolFlag, messageIsRequest, messageInfo):
        ...
        print(
            "Processing the HttpMessage got origin header request origin_header_request as " + origin_header_request)
        ...
        print(
            "Processing the HttpMessage got origin header request origin_header_response as " + origin_header_response)
